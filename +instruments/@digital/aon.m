function out = aon(obj, param)
% aon - Asset or Nothing Digital Option Price formula
% based on Zhang 2nd Ed.  Pager 404 - 405
%TODO : Psi and Eta  and Gap/strike sensitivity
...
% npv is the core pricer calculation function
    ...
    if ~isempty(indx)
        ...
        out(indx) = exp(-Q(indx)  .* T(indx)) .* S(indx) .* normcdf(type(indx) .* d1(indx));
    end
